        ...
        <div class="max-w-4xl mx-auto text-center mb-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-r from-gray-100 to-white p-5 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    ...
                    <a href="{{ route('services') }}" class="text-blue-600 font-semibold group-hover:text-blue-800 transition">Learn More →</a>
                </div>
                ...
                <div class="bg-gradient-to-r from-gray-100 to-white p-6 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    ...
                    <a href="{{ route('services') }}" class="text-green-600 font-semibold group-hover:text-green-800 transition">Learn More →</a>
                </div>
                ...
                <div class="bg-gradient-to-r from-gray-100 to-white p-6 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    ...
                    <a href="{{ route('services') }}" class="text-purple-600 font-semibold group-hover:text-purple-800 transition">Learn More →</a>
                </div>

                <!-- Security Solutions -->
                <div class="bg-gradient-to-r from-gray-100 to-white p-6 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    <div class="w-12 h-12 bg-red-100 rounded-full flex items-center justify-center mb-4">
                        <i class="ri-robot-line text-xl text-red-600 group-hover:text-red-800 transition"></i>
                    </div>
                    <h3 class="text-xl font-bold mb-2 group-hover:text-gray-800 transition">AI-Powered Security</h3>
                    <a href="{{ route('services') }}" class="text-red-600 font-semibold group-hover:text-red-800 transition">Learn More →</a>
                </div>
                ...
                <div class="bg-gradient-to-r from-gray-100 to-white p-6 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    ...
                    <a href="{{ route('services') }}" class="text-yellow-600 font-semibold group-hover:text-yellow-800 transition">Learn More →</a>
                </div>
                ...
                <div class="bg-gradient-to-r from-gray-100 to-white p-6 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    ...
                    <a href="{{ route('services') }}" class="text-indigo-600 font-semibold group-hover:text-indigo-800 transition">Learn More →</a>
                </div>
                ...
                <div class="bg-gradient-to-r from-gray-100 to-white p-6 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    <div class="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-4">
                        <i class="ri-windows-line text-xl text-blue-600 group-hover:text-blue-800 transition"></i>
                    </div>
                ...
                <div class="bg-gradient-to-r from-gray-100 to-white p-6 rounded-lg border border-gray-300 shadow-lg hover:shadow-xl transition group flex flex-col items-center justify-center text-center cursor-pointer">
                    <div class="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-4">
                        <i class="ri-phone-line text-xl text-indigo-600 group-hover:text-indigo-800 transition"></i>
                    </div>
