...
<body class="bg-white text-gray-900">
    ...
    <!-- HEADER -->
        <header class="w-full fixed top-0 z-50 bg-slate-900 shadow-sm">
           ...
           <!-- Desktop Menu -->
            <nav class="hidden md:flex space-x-8 text-[17px] font-medium text-white">
                <a href="{{ route('home') }}" class="hover:text-blue-400 transition duration-300">Home</a>
                <a href="{{ route('about') }}" class="hover:text-blue-400 transition duration-300">About Us</a>
                <a href="{{ route('services') }}" class="hover:text-blue-400 transition duration-300">Services</a>
                <a href="{{ route('news') }}" class="hover:text-blue-400 transition duration-300">News & Events</a>
                <a href="{{ route('career') }}" class="hover:text-blue-400 transition duration-300">Career</a>
            </nav>
